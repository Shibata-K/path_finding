...
private:
	...
	static int getWalkCost(Mass& m) { status s = m.getStatus(); if(s == status::BLANK)return 3; if (s == status::WATER)return 9; if (s == status::ROAD)return 1;}//●
...
inline bool asc(const Mass* o1, const Mass* o2) {//●inline
